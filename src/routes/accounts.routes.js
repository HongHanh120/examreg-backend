...
router.get("/student", token.verify, privilege.verify(2), accountController.getStudentList);
router.get("/admin", token.verify, privilege.verify(1), accountController.getAdminList);
router.get("/examination/:examination_id", token.verify, accountController.getCurrentExaminationToken);
